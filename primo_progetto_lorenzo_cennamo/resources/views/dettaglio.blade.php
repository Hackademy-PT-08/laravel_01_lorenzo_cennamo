...
<div class="cotainer-fluid my-5">
    <div class="row">
        <div class="col-12">
            <h1 class="text-center bg-primary">Dettaglio Docente</h1>
        </div>
    </div>
</div>
  ...
  <div class="row justify-content-centre">
    <div class="col-12">
      <div class="card" style="width: 18rem;">
        ...
        <div class="card-body">
          <h5 class="card-title">{{$personale['name']}} {{$personale['surname']}}</h5>
          <p class="card-text">Anni: {{$personale['age']}}</p>
          <a href="{{route('chi-siamo')}}" class="btn btn-primary">Go somewhere</a>
        </div>
      </div>
    </div>
  </div>
